...
export default function VideoHeader({ availableEvents, call }) {
  ...
  return (
    <div className={'absolute md:flex md:flex-row items-center justify-between gap-2 md:h-[5.4rem] w-full py-6 md:py-2 px-4 md:px-10 bg-transparent md:bg-[#19232D]'} style={{ zIndex: 3000 }}>
      <div
        style={{ zIndex: 3000 }}
      ...
      <div
        id="session-timer"
        className='flex justify-center gap-2 px-10 bg-white py-4 rounded-md text-md text-greenbg'
        // className={`${
