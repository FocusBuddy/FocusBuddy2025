...
export default function VideoHeader({ availableEvents, call }) {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-between gap-2  w-full mb-8 h-[8rem] md:h-[5.4rem] py-2 px-4 md:px-10 bg-[#19232D]">
      <div style={{zIndex: 3000}} className={`${window.screen.width < 676 ? 'static' : 'fixed top-3 left-10'} flex gap-4 bg-white p-3 rounded-md`}>
          ...
          <div className="relative bg-white rounded-lg shadow">
            ...
            <div className="p-6 md:p-10">
              ...
              <div className="mt-8 text-formgray text-md xl:text-lg space-y-3">
                <p>
                  Thank you for helping us keep Focusmate safe and productive!
                </p>
                <p>
